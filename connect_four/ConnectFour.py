...
'''
Connect Four Class: includes game logic, win/draw detection, board rendering, and cloning (used for simulations)
'''
class ConnectFour:
    def __init__(self):
...
'''
Render:
Input: Connect Four board state (tensor with cells values: -1, 0 , 1)
Output: Connect Four visual
'''
def render(tensor):
    array = tensor.numpy()
